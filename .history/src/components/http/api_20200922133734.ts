...
export default {
   ...
   //提交机票订单
   postAirorders({users,contactName,contactPhone,invoice,air,seat_xid}: {users: any;contactName: string;contactPhone: string;invoice: boolean;air: number;seat_xid: string}){
  return service.post(`airorders`,{users,contactName,contactPhone,invoice,air,seat_xid},{
    headers:{
