...
export default {
   ...
   //提交机票订单
   postAirorders({users,contactName,contactPhone,invoice,air,seatxid}: {users: any;contactName: string;contactPhone: string;invoice: boolean;air: number;seatxid: string}){
  return service.post(`airorders`,{users,contactName,contactPhone,invoice,air,seatxid},{
    headers:{
