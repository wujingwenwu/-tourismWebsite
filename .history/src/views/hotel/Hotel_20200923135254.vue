    ...
    <div class="hotelbox">
      ...
      <div class="searchbox">
        ...
        <div class="timebox d-f a-l">
          <img class="imgtime" src="../../img/data.png" alt />
          <a-range-picker @change="onChange" placeholder="入驻时间" />
        </div>
        <div class="peobox d-f a-l">
          <div class="d-f a-l" @click="openbox">
            ...
            <div class="rightimgbox">
              <img class="imgsss" src="../../img/user.png" alt />
            </div>
          </div>
          ...
          <div class="d-f">
            ...
            <div v-if="flag === false">
              ...
              <div @click="openhigeht" class="fs14">
                <img class="imgss" src="../../img/open.png" alt /> 等25个区域
              </div>
            </div>
            <div v-if="flag === true">
              ...
              <div @click="opendown" class="fs14">
                <img class="imgss" src="../../img/close.png" alt /> 等25个区域
              </div>
            </div>
          </div>
            ...
            <div class="d-f ratebox">
              <div class="m-r-10">
                <a-tooltip placement="bottom">
                  ...
                  <div>
                    <img class="imgss" src="../../img/huangguan.png" alt />
                    <img class="imgss" src="../../img/huangguan.png" alt />
                    <img class="imgss" src="../../img/huangguan.png" alt />
                    ¥322
                  </div>
                ...
                <div class="chosefont1">
                  <a-dropdown>
                    ...
                    <div class="w-1 d-f a-l j-c-sb hotelsearchbox">
                      ...
                      <div class="m-r-10">
                        <img class="imgsss" src="../../img/down.png" alt />
                      </div>
                    </div>
                  </a-dropdown>
                </div>
              ...
              <div class="chosefont">
                <div class="chosefont1">
                  <a-dropdown>
                    <template v-slot:overlay>
                      <a-menu>
                        <a-menu-item v-for="(item,index) in brands" :key="index" @change="handlebrand">
                          <a-radio v-model:checked="item.checked"></a-radio>
                          {{item.name}}
                        </a-menu-item>
                      </a-menu>
        ...
        <div class="hotelbox">
          ...
          <div class="d-f w-1 m-t-10 m-b-15" v-for="(item,index) in hotellist" :key="index">
            ...
            <div class="hbmsgbox">
              ...
              <div class="hbmsgfont">
                <img class="imgss" src="../../img/location.png" alt />
                位于:{{item.address}}
              </div>
            </div>
            <div class="otherbox">
              ...
              >
                ...
                <div>
                  ...
                  <span>起</span>
                  <img class="rightimg" src="../../img/right.png" alt />
                </div>
              </div>
            </div>
          </div>
