  ...
  <div class="comment d-f f-d-c a-i-c">
    <div class="top d-f j-c-s-a">
      <div class="d-f">
        ...
        <div class="font m-l-10 login-hover hvr-underline-from-center" :class="[index===1?'actives':'']" @click="click">旅游攻略</div>
        <div class="font m-l-10 login-hover hvr-underline-from-center" :class="[index===2?'actives':'']">酒店</div>
        <div class="font m-l-10 login-hover hvr-underline-from-center" :class="[index===3?'actives':'']">国内机票</div>
      </div>
