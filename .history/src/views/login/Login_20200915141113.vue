  ...
  <div class="login">
    <div class="image d-f j-c-c a-i-c">
      <div class="logins">
        ...
        <div v-if="flag===false">
          <div class="d-f a-i-c f-d-c w-100">
            <a-form ref="ruleForms" :model="forms" @finish="handleFinish" :rules="ruless" :wrapper-col="wrapperCol">
...
export default defineComponent({
  ...
  setup() {
    ...
    //  validate().then(()=>{
    //    api.postRegister({username: data.forms.telephone,nickname: data.forms.name,captcha: data.forms.verification,password: data.forms.confirm}).then((res)=>{
    //    console.log(res);
    //  }).catch((err)=>{
    //    console.log(err);
    //  })
    ...
    const handleFinish=(values: string): void=>{
   console.log(values);
    }
    return {
      ...toRefs(data),
