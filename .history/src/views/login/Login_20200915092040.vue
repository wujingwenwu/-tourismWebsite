          ...
          <div class="d-f a-i-c f-d-c w-100">
            <a-form ref="ruleForm" :model="form" :rules="rules" :wrapper-col="wrapperCol">
              ...
              <a-form-item ref="password" name="password">
                <a-input-password v-model:value="form.password" placeholder="请输入密码" class="inpit m-t-20" />
              </a-form-item>
            </a-form>
          </div>
         ...
         <div class="d-f a-i-c f-d-c w-100">
            <a-form ref="ruleForms" :model="forms" :rules="ruless" :wrapper-col="wrapperCol">
              ...
              <a-form-item ref="verification" name="verification">
                <a-input v-model:value="forms.verification" placeholder="请输入验证码"  class="inpit m-t-20" />
              </a-form-item>
              <div>发送验证码</div>
              </div>
              <a-form-item ref="name" name="name">
               ...
               <a-form-item ref="cypher" name="cypher">
                <a-input-password v-model:value="forms.cypher" placeholder="请输入密码" class="inpit m-t-20" />
              </a-form-item>
               <a-form-item ref="confirm" name="confirm">
                <a-input-password v-model:value="forms.confirm" placeholder="请再次确认密码" class="inpit m-t-20" />
              </a-form-item>
            </a-form>
          </div>
        </div>
      ...
      rules: {
        ...
        ruless: {
         telephone: [
          ...
          { min: 11, max: 11, message: "手机号格式不对", trigger: "blur",pattern: /^(?:(?:\+|00)86)?1(?:(?:3[\d])|(?:4[5-7|9])|(?:5[0-3|5-9])|(?:6[5-7])|(?:7[0-8])|(?:8[\d])|(?:9[1|8|9]))\d{8}$/, },
        ],
        verification: [
