        ...
        <div v-if="flag===true">
          <div class="d-f a-i-c f-d-c w-100">
            <a-form ref="ruleForm" :model="form" :rules="rules">
              <a-form-item ref="username" name="username" required has-feedback>
                <a-input v-model:value="form.username" autocomplete="off"  placeholder="请输入手机号" class="inpit m-t-30" />
              </a-form-item>
