        ...
        <div class="m-l-20 d-f">
          ...
          <div class="m-l-10">
            <a-select
              ...
              ref="select"
              @change="handleChange"
            >  <a-select-option :value="item" v-for="(item,index) in flightTimes" :key="index"><div class="d-f"></div></a-select-option></a-select>
          </div>
            <div class="m-l-10">
            <a-select
              v-model:value="values"
              ...
              ref="select"
              @change="handleChange"
            >  <a-select-option :value="item" v-for="(item,index) in company" :key="index">{{item}}</a-select-option></a-select>
          </div>
          <div class="m-l-10">
            <a-select
              v-model:value="values"
              ...
              ref="select"
              @change="handleChange"
            >  <a-select-option :value="item" v-for="(item,index) in arr" :key="index">{{item}}</a-select-option></a-select>
          </div>
        </div>
      </div>
