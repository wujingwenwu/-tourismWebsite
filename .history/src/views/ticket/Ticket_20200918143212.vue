...
<div class="m-l-10 m-t-5">出发时间</div>
  <div class="input m-l-10">
  <a-date-picker v-model:value="value2" @change="onChange" placeholder="请选择日期"/>
  </div>
</div>
 <div class="button">
 <a-button type="primary" class="button" block>
            搜索
 ...
 <img :src="item.cover" alt="图片加载失败" width="225" height="150">
 <div class="d-f departCity">
 <div class="color">{{item.departCity}}---</div>
 <div class="color">{{item.destCity}}</div>
 <div class="color m-l-30">￥{{item.price}}</div>
 </div>
 </div>
 </div>
 </div>
